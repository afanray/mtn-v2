      ...
      <div class="container clearfix">
        <div class="header-inner py-20">
          <div class="logo-outer">
            <div class="logo"><a href="/"><img src="{{ asset('assets/media/logos/logo-mtn.png') }}" class="logo-landing" alt="Logo"></a></div>
          </div>
          ...
          <div class="nav-outer clearfix">
            ...
            <nav class="main-menu navbar-expand-lg">
              <div class="navbar-header">
                <div class="logo-mobile"><a href="/"><img src="{{ asset('assets/media/logos/logo-mtn.png') }}" alt="Logo" class="logo-landing"></a></div>
                <!-- Toggle Button -->
              ...
              <div class="navbar-collapse collapse clearfix" id="main-menu">
                <ul class="navigation clearfix">
                  ...
                  <li @class(['current'=>$activeMenu === 'about'])><a href="{{ route('home.about') }}">Tentang</a></li>
                  <li @class(['current'=>$activeMenu === 'news'])><a href="{{ route('home.news') }}">Berita & Kegiatan</a></li>
          ...
          <div class="menu-right d-none d-lg-flex align-items-center ml-lg-auto">
            <a href="{{ route('dashboard-capaian') }}" class="theme-btn style-one">Dashboard <i class="fas fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-xl-3 col-sm-6 col-6 col-small">
          <div class="footer-widget about-widget" style="max-width: unset">
            <div class="footer-logo mb-20">
              <a href="/"><img src="{{ asset('assets/media/logos/logo-mtn.png') }}" alt="Logo" style="max-width: 235px;"></a>
            </div>
            <div class="d-flex">
              ...
              <p class="font-sm" style="font-size: 14px;line-height: 1.5">Kementerian Perencanaan Pembangunan Nasional / Badan Perencanaan Pembangunan Nasional (Bappenas)</p>
            </div>
        ...
        <div class="col-xl-4 col-md-6 d-flex flex-column align-items-end">
          <div class="footer-widget contact-widget">
            ...
            <ul class="list-style-three">
              <li><i class="fas fa-map-marker-alt"></i> Sekretariat Nasional Manajemen Talenta Nasional</li>
              <li><i class="fas fa-map-marker-alt"></i> Jl. Taman Suropati No.62 Jakarta 10310</li>
              <li><i class="fas fa-phone"></i> Telepon : <a href="callto:+620213196207">021-3196207</a></li>
            </ul>
          </div>
        </div>
      </div>
      <div class="copyright-area text-center">
        <p>Hak Cipta {{date('Y')}} <a href="/">Manajemen Talenta Nasional</a>. Hak Cipta Dilindungi Undang-Undang</p>
      </div>
    </div>
