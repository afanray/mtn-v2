      ...
      <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
          <a href="/dashboard" class="d-lg-none">
            <img alt="Logo" src="{{ asset('/assets/media/logos/logo-mtn.png') }}" class="h-30px" />
          </a>
        </div>
        <!--end::Mobile logo-->
    ...
    <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
      ...
      <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
        ...
        <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
          <!--begin::Logo image-->
          <a href="/dashboard">
            <img alt="Logo" src="{{ asset('/assets/media/logos/logo-mtn.png') }}"
                 class="h-45px app-sidebar-logo-default theme-light-show" />
            <img alt="Logo" src="{{ asset('/android-chrome-192x192.png') }}" class="h-20px app-sidebar-logo-minimize" />
          </a>
          <!--end::Logo image-->
        ...
        <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
          ...
          <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
              ...
              <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ $activeMenu === 'dashboard' ? 'active' : '' }}" href="/dashboard">
              ...
              <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ $activeMenu === 'capaian-indikator' ? 'active' : '' }}" href="{{ route('capaian-indikator.index') }}">
                    <span class="menu-icon">
              ...
              <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ $activeMenu === 'data' ? 'active' : '' }}" href="{{ route('data.index') }}">
                    <span class="menu-icon">
              ...
              <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ $activeMenu === 'summary' ? 'active' : '' }}" href="{{ route('capaian-indikator.summary') }}">
                    <span class="menu-icon">
              ...
              <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ $activeMenu === 'ht' ? 'active' : '' }}" href="{{ route('highlight-talenta.index') }}">
                      <span class="menu-icon">
                        <i class='fa fa-users fs-4'></i>
                      </span>
              ...
              <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ $activeMenu === 'ant' ? 'active' : '' }}" href="{{ route('anugrah-talenta.index') }}">
                      <span class="menu-icon">
                        <i class='fa fa-users fs-4'></i>
                      </span>
              ...
              <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ $activeMenu === 'at' ? 'active' : '' }}" href="{{ route('ajang-talenta.index') }}">
                      <span class="menu-icon">
                        <i class='fa fa-users fs-4'></i>
                      </span>
              ...
              @if(\App\Models\User::isSuperAdmin())
                ...
                <div class="menu-item">
                  <!--begin:Menu link-->
                  <a class="menu-link {{ $activeMenu === 'pustaka' ? 'active' : '' }}" href="{{ route('pustaka.index') }}">
                        <span class="menu-icon">
              ...
              <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ $activeMenu === 'pb' ? 'active' : '' }}" href="{{ route('praktik-baik.index') }}">
                      <span class="menu-icon">
                        <i class='fa fa-users fs-4'></i>
                      </span>
              ...
              @if(\App\Models\User::isSuperAdmin())
                ...
                <div class="menu-item">
                  <!--begin:Menu link-->
                  <a class="menu-link {{ $activeMenu === 'testi' ? 'active' : '' }}" href="{{ route('testimoni.index') }}">
                      <span class="menu-icon">
              ...
              <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ $activeMenu === 'user' ? 'active' : '' }}" href="{{ route('user.index') }}">
                    <span class="menu-icon">
                      <i class='fa fa-users fs-4'></i>
                    </span>
              ...
              <div data-kt-menu-trigger="click" @class([
                'menu-item',
                'menu-accordion',
                'hover show'=>in_array($activeMenu,['master-talenta','master-lembaga','master-penghargaan'])
                ])>
                <!--begin:Menu link-->
                ...
                <div class="menu-sub menu-sub-accordion">
                  ...
                  <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ $activeMenu === 'master-talenta' ? 'active' : '' }}" href="{{ route('data-master.talenta.index') }}">
                  ...
                  <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ $activeMenu === 'master-lembaga' ? 'active' : '' }}" href="{{ route('data-master.lembaga.index') }}">
                  ...
                  <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ $activeMenu === 'master-penghargaan' ? 'active' : '' }}" href="{{ route('data-master.penghargaan.index') }}">
                      <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span></span>
        ...
        <div id="kt_app_footer" class="app-footer ">
          ...
          <div class="app-container  container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3 ">
            ...
            <div class="text-gray-900 order-2 order-md-1">
              Hak Cipta {{date('Y')}} <a href="/">Manajemen Talenta Nasional</a>. Hak Cipta Dilindungi Undang-Undang
            </div>
            <!--end::Copyright-->
