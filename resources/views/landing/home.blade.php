                    ...
                    <div class="w-100 carousel-content">
                        <div class="cc-content">
                            ...
                            <p class="text-left">
                                ...
                                menghasilkan Talenta, melalui pendekatan makro yang berfokus pada ekosistem pendukung di
                                tingkat negara serta pendekatan mikro yang berfokus pada sinergi dan keberlanjutan proses
                                pembibitan, pengembangan potensi, dan penguatan ketalentaan
                            </p>
                            <a href="{{ route('home.about') }}" class="theme-btn">Tentang MTN <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                        <img src="{{ asset('assets/landing/images/background/mtn-slide-1.jpeg') }}"
                ...
                <div class="dashboard-screenshot-item">
                    <div class="w-100 carousel-content">
                        <div class="cc-content">
                            ...
                            <p class="text-left">
                                Pelajari berbagai referensi kebijakan pemerintah, panduan pelaksanaan, jelajahi video dan
                                infografis rangkuman data dan informasi tentang Manajemen Talenta Nasional (MTN) dalam
                                format media digital di halaman Pustaka.
                            </p>
                            <a href="{{ route('home.pustaka') }}" class="theme-btn">Pustaka MTN <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                        <img src="{{ asset('assets/landing/images/background/mtn-slide-2.png') }}"
                            alt="Dashboard Screenshot">
                    </div>
                </div>
                <div class="dashboard-screenshot-item">
                    <div class="w-100 carousel-content">
                        <div class="cc-content">
                            ...
                            <p class="text-left">
                                Berita sorotan talenta dan kumpulan informasi kegiatan intervensi Talenta yang dilaksanakan
                                oleh Kementerian dan Lembaga Gugus Tugas Manajemen Talenta Nasional.
                            </p>
                            <a href="{{ route('home.news') }}" class="theme-btn">Berita & Kegiatan <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                        <img src="{{ asset('assets/landing/images/background/mtn-slide-3.png') }}"
                            alt="Dashboard Screenshot">
                    </div>
                </div>
                <div class="dashboard-screenshot-item">
                    <div class="w-100 carousel-content">
                        <div class="cc-content">
                            ...
                            <p class="text-left">
                                Kumpulan pengetahuan Praktik Baik yang merupakan pembelajaran dari hasil pelaksanaan
                                kegiatan intervensi Manajemen Talenta Nasional dari pemangku kepentingan pemerintah.
                            </p>
                            <a href="{{ route('home.praktik-baik') }}" class="theme-btn">Praktik Baik <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                        <img src="{{ asset('assets/landing/images/background/mtn-slide-4.png') }}"
                            alt="Dashboard Screenshot">
                    </div>
                </div>
                <div class="dashboard-screenshot-item">
                    <div class="w-100 carousel-content">
                        <div class="cc-content">
                            ...
                            <p class="text-left">
                                Dashboard untuk mendukung pemantauan ringkasan jumlah talenta berdasar kategori dan capaian
                                indicator capaian talenta berdasarkan sasaran Desain Besar Manajemen Talenta Nasional
                            </p>
                            <a href="{{ route('dashboard-capaian') }}" class="theme-btn">Dashboard Monitoring <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                        <img src="{{ asset('assets/landing/images/background/mtn-slide-5.png') }}"
                            alt="Dashboard Screenshot">
                    </div>
                </div>
                <div class="dashboard-screenshot-item">
                    <div class="w-100 carousel-content">
                        <div class="cc-content">
                            ...
                            <p class="text-left">
                                Halaman pengelolaan data dan pengaturan pertukaran data Manajemen Talenta Nasional bagi
                                anggota Gugus Tugas dan Administrator Sekretariat MTN
                            </p>
                            <a href="{{ route('dashboard-capaian') }}" class="theme-btn">Sinergi Data <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                        <img src="{{ asset('assets/landing/images/background/mtn-slide-6.png') }}"
                            alt="Dashboard Screenshot">
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="section-title mb-55 d-flex flex-column w-100">
                        <h2>Tentang</h2>
                        <p>Portal MTN (Manajemen Talenta Nasional) merupakan platform online yang dikembangkan untuk
                            mendukung tata kelola MTN dalam sosialisasi informasi umum mengenai DBMTN 2023-2045 kepada
                            masyarakat luas, penyimpanan data talenta nasional,mendukung fungsi monitoring dan evaluasi
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 mb-5">
                    <div class="solution-item wow fadeInUp delay-0-2s"
                        ...
                        <a href="{{ route('home.about') }}" class="learn-more">Halaman Tentang <i
                                class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 mb-5">
                    <div class="solution-item wow fadeInUp delay-0-2s"
                        ...
                        <a href="{{ route('home.pustaka') }}" class="learn-more">Halaman Pustaka <i
                                class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 mb-5">
                    <div class="solution-item wow fadeInUp delay-0-2s"
                        ...
                        <a href="{{ route('home.news') }}" class="learn-more">Halaman Berita dan Kegiatan <i
                                class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 mb-5">
                    <div class="solution-item wow fadeInUp delay-0-2s"
                        ...
                        <a href="{{ route('home.praktik-baik') }}" class="learn-more">Halaman Praktik Baik <i
                                class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 mb-5">
                    <div class="solution-item wow fadeInUp delay-0-2s"
                        ...
                        <a href="{{ route('dashboard-capaian') }}" class="learn-more">Halaman Dashboard <i
                                class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 mb-5">
                    <div class="solution-item wow fadeInUp delay-0-2s"
                        ...
                        <a href="{{ route('dashboard-capaian') }}" class="learn-more">Halaman Sinergi Data <i
                                class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-12">
                    <div class="news-more-btn text-center pt-30">
                        <a href="{{ route('home.highlight-talenta') }}" class="theme-btn style-three">Lihat Highlight
                            Talenta Lainnya <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="blog-section rel z-1 pb-210 rpb-100 rpb-150 rmb-30">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-12">
                    <div class="news-more-btn text-center pt-30">
                        <a href="{{ route('home.anugrah-talenta') }}" class="theme-btn style-three">Lihat Anugrah Talenta
                            Lainnya <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="blog-section rel z-1 pb-100 rpb-100 rpb-150 rmb-30">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-12">
                    <div class="news-more-btn text-center pt-30">
                        <a href="{{ route('home.ajang-talenta') }}" class="theme-btn style-three">Lihat Ajang Talenta
                            Lainnya <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                @foreach ($praktik_baik as $h)
                    <div class="col-xl-3 col-md-6">
                        <div class="blog-item wow fadeInUp delay-0-2s">
                            <div class="image">
                                <img src="{{ $h->foto ? asset('storage/praktik_baik/' . $h->foto) : '/assets/landing/images/blog/blog1.jpg' }}"
                                    alt="Foto">
                            </div>
                            <div class="blog-author justify-content-center">
                                <h5>{{ $h->bidang->name }}</h5>
                            ...
                            <a href="{{ route('home.praktik-baik-detail', [$h->id . '-' . Illuminate\Support\Str::slug($h->nama_program, '-')]) }}"
                                class="learn-more">Lihat <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                @endforeach
                <div class="col-lg-12">
                    <div class="news-more-btn text-center pt-30">
                        <a href="{{ route('home.praktik-baik') }}" class="theme-btn style-three">Lihat Praktik Baik
                            Lainnya <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-end mb-20">
                ...
                <div class="col-xl-7 col-lg-4 d-flex justify-content-end">
                    <button class="theme-btn style-one mr-4 add-testimoni"><i class="fa fa-plus mr-2"></i> Isi
                        Testimoni</button>
                    ...
                    @foreach ($testimoni as $t)
                        ...
                        <div class="feedback-item-two {{ $class }}">
                            ...
                            <div class="feedback-author">
                                <img src="{{ asset('storage/testimoni/' . $t->foto) }}" class="mr-3" alt="avatar"
                                    style="width: 60px;height: 60px;border-radius: 50%;object-fit: cover; border: 1px solid var(--primary-color);margin-bottom: 0" />
                    ...
                    <form id="test-form" action="{{ route('home.common.post-testi') }}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="lembaga_name" id="lembaga_name"
                                    placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="g-recaptcha" data-sitekey="{{ env('RECAPTCHA_SITE_KEY') }}" data-callback="getR"
                                data-size="invisible">
                            </div>
                        </div>
                        {{ csrf_field() }}
