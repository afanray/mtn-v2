      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-12">
          <div class="news-more-btn text-center pt-30">
            <a href="{{ route('home.highlight-talenta') }}" class="theme-btn style-three">Kunjungi Halaman <i class="fas fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="blog-section rel z-1 pb-100 rpb-100 rpb-150 rmb-30">
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-12">
          <div class="news-more-btn text-center pt-30">
            <a href="{{ route('home.anugrah-talenta') }}" class="theme-btn style-three">Kunjungi Halaman <i class="fas fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="blog-section rel z-1 pb-100 rpb-100 rpb-150 rmb-30">
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-12">
          <div class="news-more-btn text-center pt-30">
            <a href="{{ route('home.ajang-talenta') }}" class="theme-btn style-three">Kunjungi Halaman <i class="fas fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
