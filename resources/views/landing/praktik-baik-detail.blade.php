    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <div class="blog-details-content rmb-75">
            <div class="blog-standard-item">
              <img src="{{ asset('storage/praktik_baik/'.$praktik_baik->foto) }}" alt="Blog" style="object-fit: cover;height: 519px;">
              <ul class="blog-meta">
                <li><i class="far fa-calendar-alt"></i>{{ date('d M Y', strtotime($praktik_baik->created_at)) }}</li>
        ...
        <div class="col-lg-4 col-md-8">
          <div class="project-information bg-blue text-white mb-50 mr-xl-5 wow fadeInDown delay-0-2s" style="visibility: visible; animation-name: fadeInDown;margin-top: 0">
