    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <ul class="project-filter mb-55">
            ...
            @foreach($bidang as $b)
              <li @class(['current'=>$b->id == $bidang_id])><a href="{{ route('home.highlight-talenta',['_b'=>$b->id]) }}">{{ $b->name }}</a></li>
            @endforeach
          </ul>
        </div>
      </div>
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link " id="lists-tab" data-toggle="tab" data-target="#lists" type="button" role="tab" aria-controls="lists" aria-selected="false">
            <i class="fa fa-list"></i>
            Daftar
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="maps-tab" data-toggle="tab" data-target="#maps" type="button" role="tab" aria-controls="maps" aria-selected="true">
    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h4 class="modal-title" id="list-label"><i class="ft-eye mr-2"></i><span class="text-white">Daftar Kegiatan</span></h4>
...
<link href="{{ asset('assets/landing/js/leaflet/leaflet.css') }}" rel="stylesheet" type="text/css" media="all" />
<link href="{{ asset('assets/landing/js/leaflet/beautify/leaflet-beautify-marker-icon.css') }}" rel="stylesheet" type="text/css" media="all" />
<style>
  .nav-tabs .nav-link{
    border: none;
    border-radius: 0;
