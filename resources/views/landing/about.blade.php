  ...
  <section class="page-banner bg-blue rel z-1" style="">
    <div class="container">
      <div class="banner-inner">
        <h1 class="page-title wow fadeInUp delay-0-2s">Tentang</h1>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-xl-5 col-lg-6">
          <div class="about-page-content rmb-65 wow fadeInLeft delay-0-2s" style="visibility: visible; animation-name: fadeInLeft;">
            <p>MTN adalah rangkaian upaya terstruktur dan berkelanjutan dalam menghasilkan Talenta, melalui pendekatan makro yang berfokus pada ekosistem pendukung di tingkat negara serta pendekatan mikro yang berfokus pada sinergi dan keberlanjutan proses pembibitan, pengembangan potensi, dan penguatan ketalentaan.
              <br />
        ...
        <div class="col-xl-7 col-lg-6">
          <div class="about-page-images justify-content-lg-end wow fadeInRight delay-0-2s" style="visibility: visible; animation-name: fadeInRight;">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="solution-item wow fadeInUp delay-0-2s" style="visibility: visible; animation-name: fadeInUp;">
            <div class="solution-content">
              ...
              <p>Meningkatkan jumlah dan kualitas SDM Iptek nasional yang berkontribusi bagi kemajuan iptek dan penciptaan inovasi nasional; dan Meningkatnya rekognisi internasional talenta di bidang riset dan inovasi berbasis ajang dan portofolio.</p>
            </div>
          </div>
        </div>
        <div class="col-xl-4 col-md-6">
          <div class="solution-item wow fadeInUp delay-0-4s" style="visibility: visible; animation-name: fadeInUp;">
            <div class="solution-content">
              <i class="fa fa-palette"></i>
              <h3><a>Bidang Seni & Budaya</a></h3>
              <p>Meningkatnya jumlah dan kualitas Talenta Seni Budaya yang kreatif, kritis, konsisten berkarya dan berkontribusi bagi pemajuan kebudayaan nasional; dan Meningkatnya rekognisi internasional terhadap Talenta Seni Budaya, serta penyelenggaraan ajang dan nonajang seni budaya berkelas internasional di Indonesia.
              </p>
            </div>
          </div>
        </div>
        <div class="col-xl-4 col-md-6">
          <div class="solution-item wow fadeInUp delay-0-6s" style="visibility: visible; animation-name: fadeInUp;">
            <div class="solution-content">
              <i class="fa fa-dumbbell"></i>
              <h3><a>Bidang Olahraga</a></h3>
              <p>Meningkatnya jumlah dan kualitas Olahragawan berprestasi di tingkat dunia dan Tenaga keolahragaan bersertifikat internasional pada cabang olahraga Olimpiade dan Paralimpiade; dan Meningkatnya rekognisi internasional dan rahan prestasi talenta olahragawan Indonesia pada kejuaraan cabang olahraga Olimpiade dan Paralimpiade</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-md-8 offset-md-2">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <p>Skema hibah riset unggulan yang berorientasi pada hasil jangka menengah dan panjang dengan fleksibilitas administrasi pelaporan pelaksanaan anggaran
                  </p>
                </div>
              </div>
              <div class="card mb-3">
          ...
          <div class="row">
            <div class="col-md-8 offset-md-2">
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <p>SIMT Olahraga menjadi pusat data terpadu keolahragaan secara nasional yang berisi mengenai sistem informasi dan sistem data memuat informasi bibit talenta hingga talenta unggul. Data terpadu atlet memuat 3 komponen utama yaitu biodata atlet, riwayat dan rekam jejak dan hasil tes dan pengukuran atlet yang akan terekam dalam 1 platform/aplikasi.
                  </p>
                </div>
              </div>
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <p>Ditujukan untuk pembinaan olahraga pendidikan (formal dan nonformal) yang bersinergi dengan pembinaan olahraga prestasi melalui: Kurikulum pendidikan khusus olahragawan; Pencarian bibit dan talenta potensial di dalam dan luar negeri; serta Penyelenggaraan sentra Latihan Olahragawan Muda yang berjenjang dan berkelanjutan di Daerah.
                  </p>
                </div>
              </div>
              <div class="card mb-3">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <p>Ditujukan untuk mendorong perbaikan jaringan kompetisi talenta yang berjenjang dan berkelanjutan, serta berbasis kompetisi elit (high level competition) nasional untuk menghasilkan talenta unggul. Lebih lanjut, juga untuk mendorong peningkatan penyelenggaraan dan/atau keikutsertaan pada ajang kelas dunia, khususnya kualifikasi olimpiade dan paralimpiade dalam rangka optimalisasi kapitalisasi talenta unggul.
                  </p>
                </div>
              </div>
              <div class="card mb-3">
