      ...
      <div class="card-title w-100">
        <div class="d-flex justify-content-lg-between flex-column flex-lg-row w-100">
          ...
          <div class="d-flex align-items-center position-relative my-1">
            ...
            <a href="{{ route('user.add') }}" class="btn btn-primary me-4">
        ...
        },
        {
          ...
          render: function (data, type, row) {
            ...
            if(row.role !== 'superadmin'){
              act = `<a href="${dashboardUrl}/user/edit/${row.id}" class="edit-row me-3"><i class="fa fa-pencil-alt"></i></a>
