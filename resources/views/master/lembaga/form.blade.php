        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            <form id='add-form' class="form" action="{{ route('data-master.lembaga.save') }}" method="POST"
                ...
                <div class="card-body border-top p-9">
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label fw-semibold fs-6">Logo Lembaga</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            ...
                            <div class="image-input image-input-outline " data-kt-image-input="true"
                                ...
                                <div class="image-input-wrapper w-125px h-125px"
                                    style="background-image: url('{{ $model->image ? asset('storage/lembaga/' . $model->image) : 'https://via.placeholder.com/150' }}')">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12 fv-row">
                                    <select name="level" id="level" aria-label="Pilih Tipe Lembaga"
                                        data-placeholder="Pilih Tipe Lembaga"
                                        class="form-select form-select-solid form-select-lg">
                                        <option value="">Pilih Tipe Lembaga</option>
                                        <option value="1" @selected(old('level', $model->level) == 1)>Lembaga Induk</option>
                                        <option value="2" @selected(old('level', $model->level) == 2)>Pusat/Unit/Fakultas</option>
                                        <option value="3" @selected(old('level', $model->level) == 3)>Direktorat/Jurusan</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-6 lembaga-induk-container"
                        style="{{ ($model->level ?? 0) == 1 || ($model->level ?? 0) == 0 ? 'display: none' : '' }}">
                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Lembaga Induk</label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-12 fv-row">
                                    <select name="lembaga_induk_id" id="lembaga_induk_id" aria-label="Pilih Lembaga Induk"
                                        data-control="select2" data-placeholder="Pilih Lembaga Induk"
                                        class="form-select form-select-solid form-select-lg">
                                        <option value="">Pilih Lembaga Induk</option>
                                        @foreach ($lembagaInduk as $b)
                                            <option value="{{ $b->id }}" @selected(old('lembaga_induk_id', $lembagaIndukId) == $b->id)>
                                                {{ $b->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div class="row mb-6 lembaga-unit-container" style="{{ $model->level != 3 ? 'display: none' : '' }}">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-12 fv-row">
                                    <select name="lembaga_unit_id" id="lembaga_unit_id"
                                        aria-label="Pilih Pusat/Unit/Fakultas" data-control="select2"
                                        data-placeholder="Pilih Pusat/Unit/Fakultas"
                                        class="form-select form-select-solid form-select-lg">
                                        <option value="">Pilih Pusat/Unit/Fakultas</option>
                                        @foreach ($lembagaUnit as $b)
                                            <option value="{{ $b->id }}" @selected(old('lembaga_unit_id', $lembagaUnitId) == $b->id)>
                                                {{ $b->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-12 fv-row">
                                    <textarea class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" rows="5" placeholder="Alamat"
                                        name="address" id="address">{{ old('address', $model->address) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <a href="{{ route('data-master.lembaga.index') }}"
