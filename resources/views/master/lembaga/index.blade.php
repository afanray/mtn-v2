...
@section('title','Manajemen Master Lembaga')
@section('body')
  <!--begin::Card-->
  <div class="card">
    <!--begin::Card header-->
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-title w-100">
        <div class="d-flex justify-content-lg-between flex-column flex-lg-row w-100">
          <h3 class="card-title">Daftar Lembaga</h3>
          <!--begin::Search-->
          <div class="d-flex align-items-center position-relative my-1">
            ...
            <a href="{{ route('data-master.lembaga.add') }}" class="btn btn-primary me-4">
    ...
    <div class="card-body pt-0">
      <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_user_table">
        ...
        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
          ...
          <th class="min-w-125px">Tipe Lembaga</th>
          <th class="min-w-125px">Induk</th>
          <th class="min-w-125px">Alamat</th>
          <th class="min-w-125px">Provinsi</th>
          <th class="min-w-125px">Kabupaten/Kota</th>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function () {
      $('body').on('click', '.delete-row', function () {
        ...
        Swal.fire({
          ...
          if (result.value) {
            blockUI.block()
            $.ajax({
              url: '/dashboard/data-master/lembaga/delete/' + id,
              type: 'GET',
      ...
      var table = $('#kt_user_table').DataTable({
        ...
        searching: true,
        ajax: {
          url: `/dashboard/data-master/lembaga/data`,
          type: 'GET',
          complete: function () {
      ...
      const columns = [
        ...
        },
        {
          ...
          render: function (data, type, row) {
            switch (data) {
              case 1:
                return 'Lembaga Induk'
              case 2:
                return 'Pusat/Unit/Fakultas'
              case 3:
                return 'Direktorat/Jurusan'
            }
          },
        },
        {
          ...
          render: function (data, type, row) {
            switch (row.level) {
              ...
              case 3:
                return row.parent.name+' - '+row.parent.parent.name
            }
          },
        },
        {
        ...
        },
        {
          ...
          render: function (data, type, row) {
            return `<a href="${dashboardUrl}/data-master/lembaga/edit/${row.id}" class="edit-row me-3"><i class="fa fa-pencil-alt"></i></a>
                    ${false ? `<a href="#" id="${row.id}" class="delete-row"><i class="fa fa-trash"></i></a>` : ''}
                `;
          },
        },
      ]
