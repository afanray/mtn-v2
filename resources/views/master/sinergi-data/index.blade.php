...
@section('title', 'Manajemen Master Sinergi Data')
@section('body')
    <!--begin::Card-->
    <div class="card">
        <!--begin::Card header-->
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title w-100">
                <div class="d-flex justify-content-lg-between flex-column flex-lg-row w-100">
                    <h3 class="card-title">Sinergi Data</h3>
                    <!--begin::Search-->
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <a href="{{ route('data-master.sinergi-data.add') }}" class="btn btn-primary me-4">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_user_table">
                <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Nama K/L</th>
                        <th class="min-w-125px">Nama K/L</th>
                        <th class="min-w-125px">Produsen Data</th>
                        <th class="min-w-125px">Jenis Data</th>
                        <th class="min-w-125px">Satuan</th>
                        <th class="min-w-125px">Base URL</th>
                        <th class="min-w-125px">Key</th>
                        <th class="min-w-125px">Method</th>
                        <th class="min-w-125px">Parameter</th>
                        <th class="min-w-125px">Sinkronisasi</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('body').on('click', '.delete-row', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        blockUI.block()
                        $.ajax({
                            url: '/dashboard/data-master/sinergi-data/delete/' + id,
                            type: 'GET',
            ...
            var table = $('#kt_user_table').DataTable({
                ...
                searching: true,
                ajax: {
                    url: `/dashboard/data-master/sinergi-data/data`,
                    type: 'GET',
                    complete: function() {
        ...
        function defineColumn() {
            const columns = [{
                ...
                },
                {
                    ...
                    sortable: false,
                    render: function(data, type, row) {
                        return row.parameter ? row.parameter : '-'
                    },
                },
                {
                    data: 'last_sinkron',
                    ...
                    sortable: false,
                    render: function(data, type, row) {
                        return row.last_sinkron ? moment(data).format('DD-MM-YYYY HH:mm:ss') : '-'
                    }
                },
                {
                    data: 'created_at',
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                    <a href="/dashboard/data-master/sinergi-data/show/${row.id}" class="edit-row me-3">
                            <i class="fa fa-circle-info"></i>
                        </a>
                    <a href="${dashboardUrl}/data-master/sinergi-data/edit/${row.id}" class="edit-row me-3"><i class="fa fa-pencil-alt"></i></a>
