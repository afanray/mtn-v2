...
@section('title','Manajemen Master Referensi Penghargaan')
@section('body')
  <!--begin::Card-->
  <div class="card">
    <!--begin::Card header-->
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-title w-100">
        <div class="d-flex justify-content-lg-between flex-column flex-lg-row w-100">
          <h3 class="card-title">Daftar Referensi Penghargaan</h3>
          <!--begin::Search-->
          <div class="d-flex align-items-center position-relative my-1">
            ...
            <a href="{{ route('data-master.penghargaan.add') }}" class="btn btn-primary me-4">
    ...
    <div class="card-body pt-0">
      <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_user_table">
        ...
        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
          ...
          <th class="min-w-125px">Nama Penghargaan</th>
          <th class="min-w-125px">Frekuensi</th>
          <th class="min-w-125px">Average</th>
          <th class="min-w-125px">Tingkat</th>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function () {
      $('body').on('click', '.delete-row', function () {
        ...
        Swal.fire({
          title: 'Hapus Referensi Penghargaan',
          ...
          if (result.value) {
            blockUI.block()
            $.ajax({
              url: '/dashboard/data-master/penghargaan/delete/' + id,
              type: 'GET',
      ...
      var table = $('#kt_user_table').DataTable({
        ...
        searching: true,
        ajax: {
          url: `/dashboard/data-master/penghargaan/data`,
          type: 'GET',
          complete: function () {
      ...
      const columns = [
        ...
        },
        {
          ...
          render: function (data, type, row) {
            return data === 1 ? 'Internasional' : 'Nasional'
          },
        },
        {
          data: 'bidang.name',
        ...
        },
        {
          ...
          render: function (data, type, row) {
            return `<a href="${dashboardUrl}/data-master/penghargaan/edit/${row.id}" class="edit-row me-3"><i class="fa fa-pencil-alt"></i></a>
                    ${!row.predefined ? `<a href="#" id="${row.id}" class="delete-row"><i class="fa fa-trash"></i></a>` : ''}
                `;
          },
        },
      ]
