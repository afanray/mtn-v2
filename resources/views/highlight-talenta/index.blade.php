...
@section('title', 'Manajemen Highlight Talenta')
@section('body')
    <!--begin::Card-->
    <div class="card">
        <!--begin::Card header-->
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title w-100">
                <div class="d-flex justify-content-lg-between flex-column flex-lg-row w-100">
                    <h3 class="card-title">Daftar Highlight Talenta</h3>
                    <!--begin::Search-->
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <a href="{{ route('highlight-talenta.add') }}" class="btn btn-primary me-4">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_user_table">
                <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">ID Talenta</th>
                        <th class="min-w-125px">Nama Talenta</th>
                        <th class="min-w-125px">Penghargaan</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('body').on('click', '.delete-row', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        blockUI.block()
                        $.ajax({
                            url: '/dashboard/highlight-talenta/delete/' + id,
                            type: 'GET',
            ...
            var table = $('#kt_user_table').DataTable({
                ...
                searching: true,
                ajax: {
                    url: `/dashboard/highlight-talenta/data`,
                    type: 'GET',
                    complete: function() {
        ...
        function defineColumn() {
            const columns = [{
                ...
                {
                    data: 'talenta.kode_talenta',
                    title: 'ID Talenta',
                    sortable: true,
                },
                {
                    data: 'talenta.nama_talenta',
                    title: 'Nama Talenta',
                    sortable: true,
                },
                {
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `<a href="${dashboardUrl}/highlight-talenta/edit/${row.id}" class="edit-row me-3"><i class="fa fa-pencil-alt"></i></a>
