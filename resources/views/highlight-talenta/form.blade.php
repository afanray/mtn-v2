...
@section('body')
  <div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
      <form id='add-form' class="form" action="{{ route('highlight-talenta.save') }}" method="POST" enctype="multipart/form-data">
        <div class="card-body border-top p-9">
            ...
            <div class="col-lg-8">
              <div class="row">
                <div class="col-12 fv-row">
                  <select name="talenta_id" id="talenta_id" aria-label="Pilih Lembaga" data-control="select2"
                          data-placeholder="Pilih Talenta" class="form-select form-select-solid form-select-lg">
                ...
                <a class="form-text text-primary cursor-pointer add-talenta">Klik disini untuk membuat talenta baru.</a>
              </div>
            </div>
          </div>
          <div class="row mb-6">
            ...
            <div class="col-lg-8">
              <div class="row">
                <div class="col-12 fv-row">
                  <select name="ref_prizes_id" id="ref_prizes_id" aria-label="Pilih Penghargaan" data-control="select2"
                          data-placeholder="Pilih Penghargaan" class="form-select form-select-solid form-select-lg">
                    <option value="">Pilih Penghargaan</option>
                    @foreach($ref_prizes as $l)
                      <option value="{{ $l->id }}" @selected(old('ref_prizes_id', $model->ref_prizes_id) == $l->id) >{{ $l->name }}</option>
                    @endforeach
                  </select>
                </div>
                <a class="form-text text-primary cursor-pointer add-ref-prizes">Klik disini untuk membuat penghargaan baru.</a>
              </div>
            </div>
          </div>
          <div class="row mb-6">
            ...
            <div class="col-lg-8">
              <div class="row">
                <div class="col-12 fv-row">
                  <input type="text" name="tahun" id="tahun" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
          ...
          <div class="row mb-6">
            ...
            <div class="col-lg-8">
              <div class="row">
                <div class="col-12 fv-row">
                  <textarea name="desc_penghargaan" id="desc_penghargaan" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Deskripsi">{{ old('desc_penghargaan', $model->desc_penghargaan) }}</textarea>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="col-12 fv-row">
                  @if($model->foto_penghargaan)
                    <div class="foto-wrapper mb-3 w-200px">
                      <img src="{{ asset('storage/penghargaan/'. $model->foto_penghargaan) }}" class="w-100">
                    </div>
                  @endif
                  <input type="file" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" name="foto_penghargaan" id="foto_penghargaan"/>
                  @if($model->foto_penghargaan)
          ...
          <div class="row mb-6 bidang_fokus_id_cont" style="display: {{ $model->id &&  $model->bidang_id == \App\Constants\Common::BIDANG_RISET_ID ? 'flex' : 'none'}}">
        ...
        <div class="card-footer d-flex justify-content-end py-6 px-9">
          ...
          <a href="{{ route('highlight-talenta.index') }}"  class="btn btn-light btn-active-light-primary me-2">Batal</a>
