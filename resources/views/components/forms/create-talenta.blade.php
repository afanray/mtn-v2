        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="modal-talenta-form-body">
                    <form id='add-talenta-form' class="form" method="POST" action="{{ route('common.talenta-store') }}"
                        ...
                        <div class="fv-row mb-6">
                            ...
                            <input type="text" name="modal_nama_talenta" id="modal_nama_talenta"
                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                placeholder="Nama Talenta" />
                        </div>
                        <div class="fv-row mb-6">
                            <label class="col-form-label required fw-semibold fs-6">NIK</label>
                            <input type="text" name="modal_nik" id="modal_nik"
                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="NIK" />
                        </div>
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-12 fv-row">
                                        <input type="text" name="modal_tgllahir" id="tgllahir"
                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                        ...
                        <div class="fv-row mb-6">
                            ...
                            <select name="modal_level_talenta_id" id="modal_level_talenta_id"
                        ...
                        <x-address-selection province-name="province_id" regency-name="regency_id"></x-address-selection>
                        {{ csrf_field() }}
                    </form>
                </div>
