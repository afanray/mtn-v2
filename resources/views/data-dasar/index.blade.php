        ...
        @foreach($bidang as $k=>$v)
          ...
          <div class="card">
            ...
            <div class="card-body p-0">
              <table class="table table-striped table-row-bordered gy-5 gs-7" id="kt_bidang_{{$k}}">
                <thead>
                ...
                <tbody class="fw-semibold text-gray-600">
                  @foreach($v['data'] as $d)
                    <tr>
                      ...
                      <td class="text-end">
                        @if((\App\Models\User::isOperator() &&  ($d->status == \App\Constants\Common::STATUS_REJECT || $d->status == \App\Constants\Common::STATUS_NULL))
                          || (\App\Models\User::isPic()) || \App\Models\User::isSuperAdmin())
