...
@section('title','Manajemen Anugrah Talenta')
@section('body')
  <!--begin::Card-->
  <div class="card">
    <!--begin::Card header-->
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-title w-100">
        <div class="d-flex justify-content-lg-between flex-column flex-lg-row w-100">
          <h3 class="card-title">Daftar Anugrah Talenta</h3>
          <!--begin::Search-->
          <div class="d-flex align-items-center position-relative my-1">
            ...
            <a href="{{ route('anugrah-talenta.add') }}" class="btn btn-primary me-4">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function () {
      $('body').on('click', '.delete-row', function () {
        ...
        Swal.fire({
          ...
          if (result.value) {
            blockUI.block()
            $.ajax({
              url: '/dashboard/anugrah-talenta/delete/' + id,
              type: 'GET',
      ...
      var table = $('#kt_user_table').DataTable({
        ...
        searching: true,
        ajax: {
          url: `/dashboard/anugrah-talenta/data`,
          type: 'GET',
          complete: function () {
    ...
    function defineColumn() {
      const columns = [
        ...
        },
        {
          ...
          render: function (data, type, row) {
            return `<a href="${dashboardUrl}/anugrah-talenta/edit/${row.id}" class="edit-row me-3"><i class="fa fa-pencil-alt"></i></a>
