...
@section('body')
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            <form id='add-form' class="form" action="{{ route('pustaka.save') }}" method="POST"
                                ...
                                <div class="col-12 fv-row">
                                    <select name="type" id="type" aria-label="Pilih Tipe"
                                        ...
                                        @foreach (\App\Constants\Common::getTypePustaka() as $b)
                                            <option value="{{ $b['value'] }}" @selected(old('type', $model->type) == $b['value'])>
                                                {{ $b['label'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-12 fv-row">
                                        <textarea name="description" id="description" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            placeholder="Deskripsi">{{ old('description', $model->description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
