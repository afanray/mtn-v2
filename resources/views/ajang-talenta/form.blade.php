...
@section('body')
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            <form id='add-form' class="form" action="{{ route('ajang-talenta.save') }}" method="POST"
                ...
                <div class="card-body border-top p-9">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-12 fv-row">
                                    <input type="text" name="nama_ajang" id="nama_ajang"
                            ...
                            <div class="row">
                                <div class="col-12 fv-row">
                                    <input type="text" name="tgl_selesai" id="tgl_selesai"
                                        ...
                                        value="{{ old('tgl_selesai', $model->tgl_selesai) }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-12 fv-row">
                                    <textarea name="desc" id="desc" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                        placeholder="Deskripsi">{{ old('desc', $model->desc) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-12 fv-row">
                                    ...
                                    @endif
                                    <input type="file"
                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" name="foto"
                                        id="foto" />
                                    @if ($model->foto)
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <a href="{{ route('ajang-talenta.index') }}"
