...
@section('title',($model->id ? 'Sunting' : 'Tambah').' Ajang Talenta' )
@section('body')
  <div class="card mb-5 mb-xl-10">
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
         data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
      <div class="card-title m-0">
        <h3 class="fw-bold m-0">{{ $model->id ? 'Sunting' : 'Tambah' }} Ajang Talenta</h3>
      </div>
    </div>
    <div id="kt_account_settings_profile_details" class="collapse show">
      <form id='add-form' class="form" action="{{ route('ajang-talenta.save') }}" method="POST" enctype="multipart/form-data">
        <div class="card-body border-top p-9">
          <div class="row mb-6">
            <label class="col-lg-4 col-form-label required fw-semibold fs-6">Nama Ajang</label>
            <div class="col-lg-8">
              <div class="row">
                <div class="col-12 fv-row">
                  <input type="text" name="nama_ajang" id="nama_ajang" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                         placeholder="Nama Ajang" value="{{ old('nama_ajang', $model->nama_ajang) }}" />
                </div>
              </div>
            </div>
          </div>
          <div class="row mb-6">
            ...
            <div class="col-lg-8">
              <div class="row">
                <div class="col-12 fv-row">
                  <input type="text" name="tgl_mulai" id="tgl_mulai" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                         placeholder="Tanggal Mulai" value="{{ old('tgl_mulai', $model->tgl_mulai) }}" />
                </div>
              </div>
            </div>
          </div>
          <div class="row mb-6">
            ...
            <div class="col-lg-8">
              <div class="row">
                <div class="col-12 fv-row">
                  <input type="text" name="tgl_selesai" id="tgl_selesai" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                         placeholder="Tanggal Selesai" value="{{ old('tgl_selesai', $model->tgl_selesai) }}" />
                </div>
              </div>
            </div>
          </div>
          <div class="row mb-6">
            ...
            <div class="col-lg-8">
              <div class="row">
                <div class="col-12 fv-row">
                  <textarea name="desc" id="desc" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Deskripsi">{{ old('desc', $model->desc) }}</textarea>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="col-12 fv-row">
                  @if($model->foto)
                    <div class="foto-wrapper mb-3 w-200px">
                      <img src="{{ asset('storage/ajang_talenta/'. $model->foto) }}" class="w-100">
                    </div>
                  @endif
        ...
        <div class="card-footer d-flex justify-content-end py-6 px-9">
          ...
          <a href="{{ route('ajang-talenta.index') }}"  class="btn btn-light btn-active-light-primary me-2">Batal</a>
        ...
        form,
        {
          fields: {
            'nama_ajang': {
              validators: {
                notEmpty: {
                  message: 'Nama Ajang is required'
                },
              }
            },
            'tgl_mulai': {
            ...
            'tgl_selesai': {
              validators: {
                notEmpty: {
                  message: 'Tanggal Selesai is required'
                },
              }
            },
            'desc': {
