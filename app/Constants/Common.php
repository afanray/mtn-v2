...
class Common
{
  ...
  public static function getTypePustaka(): array
  {
    return [
      ...
      [
        'value' => self::PUSTAKA_BEASISWA,
        'label' => 'Pustaka Informasi Beasiswa'
      ],
    ];
  }
  ...
  public static function getBulan(): array
  {
    return [
      [
        'value' => '1',
  ...
  public static function getKategoriMasalah(): array
  {
    return [
      [
